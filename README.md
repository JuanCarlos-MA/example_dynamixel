...
source devel/setup.bash
```
El proceso de compilación debe terminar sin errores. Puede aparecer un Warning sobre `Note: No relevant classes found. No output generated.` en cuyo case ignórelo. 
